...
const Footer = () => {
  ...
  return (
    <footer className={`footer-section transition-colors duration-300 ${
      theme === 'light' ? 'bg-slate-100 text-slate-900 border-t border-slate-200' : ''
    }`}>
              ...
              <div className="footer-contact-item">
                <a 
                  ...
                  className={`flex items-center gap-3 transition-colors duration-200 no-underline ${
                    theme === 'light' ? 'text-slate-800 hover:text-amber-600' : 'text-slate-300 hover:text-amber-400'
                  }`}
                >
  ...
  >
    ...
    <span>xenkoratechnologies@gmail.com</span>
          ...
          <div className="lg:col-span-4 space-y-4">
            <h4 className={`footer-col-title ${theme === 'light' ? '!text-slate-900' : ''}`}>
              Services
            </h4>
            <ul className={`footer-links ${theme === 'light' ? 'light-mode-footer-links' : ''}`}>
              {[
                ...
                <li key={idx}>
                  <Link to={item.path} className={theme === 'light' ? 'text-slate-700 hover:text-amber-600' : ''}>
                    {item.name}
                  </Link>
                </li>
              ))}
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <ul className={`footer-links ${theme === 'light' ? 'light-mode-footer-links' : ''}`}>
              <li><Link to="/" className={theme === 'light' ? 'text-slate-700 hover:text-amber-600' : ''}>Home</Link></li>
              <li><Link to="/about" className={theme === 'light' ? 'text-slate-700 hover:text-amber-600' : ''}>About Us</Link></li>
              <li><Link to="/why-xenkora" className={theme === 'light' ? 'text-slate-700 hover:text-amber-600' : ''}>Why Xenkora Technologies</Link></li>
              <li><Link to="/blog" className={theme === 'light' ? 'text-slate-700 hover:text-amber-600' : ''}>Blog</Link></li>
              <li><Link to="/contact" className={theme === 'light' ? 'text-slate-700 hover:text-amber-600' : ''}>Contact Us</Link></li>
              <li><Link to="/privacy-policy" className={theme === 'light' ? 'text-slate-700 hover:text-amber-600' : ''}>Privacy Policy</Link></li>
            </ul>
          </div>
        ...
        <div className={`footer-bottom flex flex-col sm:flex-row items-center justify-between gap-4 ${
          theme === 'light' ? 'border-t border-slate-300 text-slate-700' : ''
        }`}>
          <p>© 2026 Xenkora Technologies. All Rights Reserved.</p>
          <div className="footer-bottom-links flex items-center">
            <Link to="/privacy-policy" className={theme === 'light' ? 'text-slate-700 hover:text-amber-600' : ''}>
              Privacy Policy
            </Link>
          </div>
        </div>
