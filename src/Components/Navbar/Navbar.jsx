...
import { ChevronDown, Menu, X, Sparkles, ArrowRight, Sun, Moon } from 'lucide-react';
      ...
      <nav className="max-w-7xl mx-auto bg-slate-950/85 backdrop-blur-xl border border-white/10 rounded-2xl lg:rounded-full px-4 lg:px-6 py-2.5 shadow-2xl shadow-black/80 transition-all duration-300">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-1 xl:gap-2">
            ...
            >
              ...
              {servicesDropdownOpen && (
                <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-80 bg-slate-900/95 backdrop-blur-2xl border border-amber-500/20 rounded-2xl p-2 shadow-2xl shadow-black ring-1 ring-amber-500/10 z-50">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <button
              ...
              className="p-2.5 rounded-full bg-white/5 border border-white/10 text-slate-200 hover:text-amber-400 hover:bg-white/10 transition-all duration-200"
            >
          ...
          {/* Mobile Menu & Theme Toggler Button */}
          <div className="lg:hidden flex items-center gap-2">
            <button
              onClick={toggleTheme}
              aria-label="Toggle Theme"
              className="p-2.5 rounded-xl bg-white/5 border border-white/10 text-slate-200 hover:text-amber-400"
            >
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden mt-3 pt-3 border-t border-white/10 animate-in fade-in slide-in-from-top-2 duration-200 space-y-2">
            ...
            {/* Fixed the mobile link for Why Xenkora */}
            <Link
              to="/why-xenkora"
              className="block px-4 py-2.5 text-base font-medium text-slate-200 hover:text-amber-400 hover:bg-white/5 rounded-xl"
            >
