    ...
    <section id="hero-section" className="relative overflow-hidden hero-section">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <motion.div 
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-500 dark:text-amber-400 text-xs sm:text-sm font-semibold uppercase tracking-wider mb-6"
        >
       ...
       {/* Main Hero Heading */}
        <motion.h1 
          ...
          className={`text-4xl sm:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.15] mb-6 transition-colors duration-300 ${
        ...
        <motion.p 
          ...
          className={`text-base sm:text-lg lg:text-xl max-w-3xl mx-auto mb-10 leading-relaxed transition-colors duration-300 ${
