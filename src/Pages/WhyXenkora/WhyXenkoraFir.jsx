...
const WhyXenkoraFir = () => {
  ...
  return (
    <section className={`why-choose-section py-24 relative overflow-hidden transition-colors duration-300 ${
      ...
      <div className="why-choose-container max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <motion.div 
          ...
          className="badge-pill inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-amber-500 dark:text-amber-400 text-xs sm:text-sm font-semibold uppercase tracking-wider mb-6 bg-amber-500/10 border border-amber-500/20 shadow-lg shadow-amber-500/10"
        >
          <Sparkles size={14} className="badge-icon text-amber-500 dark:text-amber-400 animate-pulse" />
        ...
        <motion.h1 
          ...
          className={`why-title text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight mb-6 leading-tight transition-colors duration-300 ${
            theme === 'light' ? '!text-black' : '!text-white'
          }`}
        >
          Why Industry Leaders Choose <br />
          Xenkora Technologies <span className="highlight-gradient bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 bg-clip-text text-transparent">In 2026.</span>
        </motion.h1>
        ...
        <motion.p 
          ...
          className={`why-description text-base sm:text-lg lg:text-xl max-w-3xl mx-auto mb-10 leading-relaxed transition-colors duration-300 ${
