...
const LocalBusinessGrowthFir = () => {
  ...
  return (
    <section className={`local-growth-section transition-colors duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div className={`local-growth-image-box transition-colors duration-300 ${
              theme === 'light' ? 'bg-white border border-slate-200 shadow-md' : ''
            }`}>
              <img 
