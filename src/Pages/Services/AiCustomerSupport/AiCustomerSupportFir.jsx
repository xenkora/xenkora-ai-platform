...
const AiCustomerSupportFir = () => {
  ...
  return (
    <section className={`ai-support-section py-24 relative overflow-hidden transition-colors duration-300 ${
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6">
            <motion.h1 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
              className={`text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight leading-tight transition-colors duration-300 ${
                theme === 'light' ? '!text-black' : '!text-white'
              }`}
            >
              Elevate CX With <span className="bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 bg-clip-text text-transparent">Autonomous AI Customer Support</span>
            </motion.h1>
            ...
            >
              {[
                ...
                >
                  <CheckCircle2 className={`w-5 h-5 shrink-0 transition-colors duration-300 ${
