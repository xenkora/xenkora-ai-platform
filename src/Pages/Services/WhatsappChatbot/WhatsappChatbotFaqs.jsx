...
const WhatsappChatbotFaqs = () => {
  ...
  return (
    <Slide>
      <section className={`wa-faq-section transition-colors duration-300 ${
            ...
            {faqsData.map((faq, index) => {
              ...
              return (
                <motion.div 
                  ...
                  className={`wa-faq-card transition-colors duration-300 ${
                ...
                >
                  ...
                  >
                    <span className={`wa-faq-question transition-colors duration-300 ${
                    ...
                    >
                      <ChevronDown className="wa-faq-icon" />
                    </motion.div>
                  </button>
                  ...
                  <AnimatePresence>
                    {isOpen && (
                      ...
                      >
                        <div className={`wa-faq-answer transition-colors duration-300 ${
