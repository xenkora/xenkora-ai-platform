...
const AiMarketingFirst = () => {
  ...
  return (
    <Zoom duration={1500}>
      <section className={`ai-marketing-section transition-colors duration-300 ${
        ...
        <div className="ai-marketing-container">
          ...
          >
            <div className={`ai-marketing-card transition-colors duration-300 ${
          ...
          <div className="ai-marketing-content">
            ...
            <motion.h2 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
              className={`ai-marketing-title transition-colors duration-300 ${
            ...
            <motion.p 
              ...
              className={`ai-marketing-desc transition-colors duration-300 ${
            ...
            >
              {[
                ...
                >
                  <CheckCircle2 className={`ai-marketing-icon transition-colors duration-300 ${
