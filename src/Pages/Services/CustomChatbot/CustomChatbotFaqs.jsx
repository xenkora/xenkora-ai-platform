...
const CustomChatbotFaqs = () => {
  ...
  return (
    <Slide>
      <section className={`custom-faq-section transition-colors duration-300 ${
            ...
            {faqsData.map((faq, index) => {
              ...
              return (
                <motion.div 
                  ...
                  className={`custom-faq-card transition-colors duration-300 ${
                ...
                >
                  ...
                  >
                    <span className={`custom-faq-question transition-colors duration-300 ${
                  ...
                  <AnimatePresence>
                    {isOpen && (
                      ...
                      >
                        <div className={`custom-faq-answer transition-colors duration-300 ${
